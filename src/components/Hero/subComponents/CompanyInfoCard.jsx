  ...
  return (
    <Container>
      <div className="flex flex-col items-center gap-10">
        <div className="w-card1 h-cardHero flex flex-col rounded-2xl shadow-lg shadow-card-1 shadow-card-2 text-black bg-white">
          ...
          <div className="flex items-center mt-6 px-6 text-light-liliac">
          ...
          {/* Description Section */}
          <div className="w-textBox h-textBox rounded-2xl mt-6 mx-auto px-2 shadow-custom-inner shadow-custom-drop">
          ...
          {/* Company Schema */}
          <div className="w-textBox rounded-2xl mt-6 mx-auto py-3 shadow-sm border border-light-liliac/20 relative">
            {/* Vertical Line */}
            ...
            <div className="grid grid-cols-2 gap-y-2 text-center relative">
              <div className="flex justify-center items-center">
                <div className="flex flex-col items-center">
                  <p className="text-xxs text-light-liliac">YEAR OF FOUNDING</p>
                  <p className="text-xs font-semibold text-dark-purple">2023</p>
                </div>
              </div>
              <div className="flex justify-center items-center">
                <div className="flex flex-col items-center">
                  <p className="text-xxs text-light-liliac">EMPLOYEES</p>
              ...
              <div className="col-span-2">
                <p className="text-xxs text-light-liliac">GENDER BREAKDOWN</p>
              ...
              <div className="col-span-2">
                <p className="text-xxs text-light-liliac">REVENUE</p>
                <p className="text-xs font-semibold text-dark-purple">
                  $50 million
                </p>
              </div>
