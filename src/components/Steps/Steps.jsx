      ...
      <div className="flex flex-col items-center gap-32">
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col lg:flex-row items-center lg:justify-start gap-3 lg:gap-24">
            ...
            <div className="flex flex-col py-10 lg:py-40 gap-6 max-w-80 lg:w-stepContainer items-center">
              ...
              <p className="lg:pt-4 font-sans font-normal text-lg tracking-wide leading-7 text-dark-purple">
