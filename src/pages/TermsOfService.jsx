      ...
      <div className="flex flex-col items-center">
        <div className="w-full px-9 mt-10 py-10">
          <h1 className="text-dark-blue text-3xl font-extrabold text-center">
            Terms of Service for Jobbyo
          </h1>

          <p className="text-dark-blue text-md mt-6">
            Welcome to Jobbyo. By accessing or using our service, you agree to
          ...
          <p className="text-dark-blue text-md mt-6">
            By using Jobbyo, you agree to be bound by these Terms of Service,
          ...
          <p className="text-dark-blue text-md mt-6">
            Jobbyo is a job application management tool designed to autofill job
          ...
          <p className="text-dark-blue text-md mt-6">
            As a user of Jobbyo, you agree to:
          </p>
          ...
          <p className="text-dark-blue text-md mt-6">
            By using Jobbyo, you authorize the app to access your Gmail and
          ...
          <p className="text-dark-blue text-md mt-6">
            ...
            property of Jobbyo or its licensors. You may not use, modify,
            reproduce, or distribute any content from Jobbyo without our
            permission.
          </p>
          ...
          <p className="text-dark-blue text-md mt-6">
            To the fullest extent permitted by law, Jobbyo shall not be liable for
          ...
          <p className="text-dark-blue text-md mt-6">
            Any disputes arising from the use of Jobbyo will be resolved through
          ...
          <p className="text-dark-blue text-md mt-6">
            ...
            contact us by email at thiago@jobbyo.ai.
          </p>
        </div>
      </div>
    </div>
