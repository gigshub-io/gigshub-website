...
import emailIconMobile from "../assets/email-icon-mobile.svg";
...
export default function ContactUs() {
  ...
  return (
    <div className="flex flex-row gap-20">
      ...
      <form className="flex flex-col lg:px-14 px-5 py-20 gap-6 w-full lg:w-contactUsFormDesktop items-center lg:items-start">
        ...
        <div className="flex flex-row gap-5 lg:gap-8 mb-8">
          <div className="flex flex-row gap-2 lg:gap-3.5 items-center">
            <div className="flex items-center justify-center bg-light-purple w-7 h-7 lg:w-9 lg:h-9 rounded-full w-p-1.5">
              <img
                src={emailIcon}
                alt="Email Icon"
        ...
        <div className="font-sans font-bold text-3xl lg:text-4xl text-dark-purple tracking-wide">
          Send us a message
        </div>
            ...
            <div className="flex flex-col gap-2">
              <label className="flex flex-col gap-2 font-sans font-normal text-base text-dark-purple tracking-wide">
                ...
                <input
                  ...
                  className="border-2 border-light-purple rounded-lg p-3 lg:w-input bg-transparent"
                ></input>
              </label>
            </div>
            <div className="flex flex-col gap-2">
